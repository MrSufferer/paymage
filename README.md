...
## ZK Payroll Testnet Demo

The `feature-zk-payroll` worktree includes a judge-ready Stellar testnet demo for real payroll proof execution. It does not use mock verifier contracts: the command below generates real Groth16 proofs locally, submits `run_payroll` to a deployed Soroban payroll contract, then generates and submits a real withdrawal proof that transfers the escrowed testnet token back to the recipient.
...
### Run The Real Testnet E2E

Prerequisites:

- Stellar CLI configured with the `payroll-admin` identity.
- Demo circuit artifacts present under `testdata/` and `target/circuits-artifacts/`.
...
The passing run on July 3, 2026 produced:
...
- Payroll proof tx: https://stellar.expert/explorer/testnet/tx/a27afe6f0bd9ef54cb3dc81658d3965b8e7d8e9f7b8a21e7146941e0cec60993
- Withdraw proof tx: https://stellar.expert/explorer/testnet/tx/a511f27bc833e32e6ce252d5ac83b7695ca189207114a6698a5737de5ee68ddb

To redeploy the payroll demo contracts after regenerating circuit keys:
